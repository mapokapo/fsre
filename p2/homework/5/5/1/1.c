/*
	...
	Zadatak 1. - Napisati program koji od korisnika traži naziv datoteke u kojoj su zapisani izmjereni
...
int main()
{
	...
	fgets(naziv_datoteke, 256, stdin);
	sscanf(naziv_datoteke, "%s", naziv_datoteke);
